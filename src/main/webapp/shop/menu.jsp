...
<div role="navigation" class="navbar header no-margin">
    <div class="container">
        <div class="navbar-header">
            ...
            <a href="/super-shop/shop/index.jsp" class="navbar-brand"><img
                    src="/super-shop/shop/assets/img/logo_red.png" alt="author by zhanglingsi"></a><!-- LOGO -->
        </div>
        <!-- BEGIN CART -->
            ...
            <div class="cart-content-wrapper">
                <div class="cart-content">
                    <ul class="scroller" style="height: 250px;">
                        <li>
                            <a href="item.html"><img src="/super-shop/shop/assets/temp/cart-img.jpg" alt="劳力士手表"
