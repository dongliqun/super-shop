                    ...
                    <li class="list-group-item clearfix dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li class="list-group-item dropdown clearfix">
                                <a href="javascript:void(0);"><i class="fa fa-circle"></i> Shoes <i
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="list-group-item dropdown clearfix">
                                        <a href="javascript:void(0);"><i class="fa fa-circle"></i> Sport <i
                                                class="fa fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                            <li><a href="product-list.html"><i class="fa fa-circle"></i> Sport 1</a>
                                            </li>
                ...
                <div class="bxslider-wrapper">
                    <ul class="bxslider" data-slides-phone="1" data-slides-tablet="2" data-slides-desktop="3"
                        ...
                        <li>
                            <div class="product-item">
                                <div class="pi-img-wrapper">
                                    <img src="/super-shop/shop/assets/temp/products/k1.jpg" class="img-responsive"
                                         alt="Berry Lace Dress">

                                    <div>
                                        <a href="/super-shop/shop/assets/temp/products/k1.jpg"
                        ...
                        <li>
                            <div class="product-item">
                                <div class="pi-img-wrapper">
                                    <img src="/super-shop/shop/assets/temp/products/k2.jpg" class="img-responsive"
                                         alt="Berry Lace Dress">

                                    <div>
                                        <a href="/super-shop/shop/assets/temp/products/k2.jpg"
                                           class="btn btn-default fancybox-button">Zoom</a>
                                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                                    </div>
                                </div>
                        ...
                        <li>
                            <div class="product-item">
                                <div class="pi-img-wrapper">
                                    <img src="/super-shop/shop/assets/temp/products/k3.jpg" class="img-responsive"
                                         alt="Berry Lace Dress">

                                    <div>
                                        <a href="/super-shop/shop/assets/temp/products/k3.jpg"
                                           class="btn btn-default fancybox-button">Zoom</a>
                                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                                    </div>
                                </div>
                        ...
                        <li>
                            <div class="product-item">
                                <div class="pi-img-wrapper">
                                    <img src="/super-shop/shop/assets/temp/products/k4.jpg" class="img-responsive"
                                         alt="Berry Lace Dress">

                                    <div>
                                        <a href="/super-shop/shop/assets/temp/products/k4.jpg"
                                           class="btn btn-default fancybox-button">Zoom</a>
                                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                                    </div>
                                </div>
                    ...
                    <div id="myCarousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img src="/super-shop/shop/assets/temp/index-sliders/slide1.jpg" class="img-responsive"
                                     alt="Berry Lace Dress">
                            </div>
                            <div class="item">
                                <img src="/super-shop/shop/assets/temp/index-sliders/slide2.jpg" class="img-responsive"
                                     alt="Berry Lace Dress">
                            </div>
                            <div class="item">
                                <img src="/super-shop/shop/assets/temp/index-sliders/slide3.jpg" class="img-responsive"
                                     alt="Berry Lace Dress">
                            </div>
                        </div>
                    </div>
